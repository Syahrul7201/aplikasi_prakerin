...
class User extends CI_Controller{
	public function __construct() {
        ...
        if(!$user){
        	$this->session->set_flashdata('pesan','<div class="alert alert-danger">Anda harus masuk dulu</div>');
            redirect('home');
        }
    }
	...
	public function p_cancel(){
		...
		$this->session->set_flashdata('pesan','<div class="alert alert-warning">Permintaan pembatalan anda telah terkirim, apabila sudah diterima maka pesanan ini akan otomatis dibatalkan</div>');
	...
	public function p_password(){
		...
		$id_user = $cek->id_user;
		if($cek->password !== $o){
			$this->session->set_flashdata('pesan','<div class="alert alert-danger">Kata sandi lama salah</div>');
			redirect('user/profile');
		}elseif($p !== $n){
			$this->session->set_flashdata('pesan','<div class="alert alert-danger">Konfirmasi kata sandi tidak sama</div>');
			redirect('user/profile');
		}else{
