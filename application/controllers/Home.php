...
class Home extends CI_Controller{
	...
	public function he(){
		...
		$mail->From = "registration@tiketet.com";
		$mail->FromName = "Tiketet Inc.";
		...
		$mail->Subject = "[Tiketet] Konfirmasi Alamat Email";
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <p>Untuk memulai pemesanan tiket di Tiketet, pertama-tama Anda harus mengaktifkan akun Anda terlebih dahulu, silahkan klik tombol dibawah ini untuk mengaktifkan akun.</p>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Tiketet Inc, Sumedang, Indonesia</span>
                  </td>
                </tr>
                <tr>
