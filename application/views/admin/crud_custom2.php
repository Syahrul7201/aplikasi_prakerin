...
<a href="<?=site_url('admin/'.$page.'/index/rec')?>" class="btn btn-primary rounded mx-1"><i class="fas fa-cloud-download-alt "></i> Download</a>
  ...
  <div id="truncate" class="modal deletemodal">
    ...
    <div class="modal-footer">
      ...
      <a href="<?=site_url('admin/'.$page.'/truncate')?>" class="waves-effect waves-green btn btn-primary modal-action modal-close">YA</a>
    </div>
  </div>
</div>
</div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <?php if($d->status=='Tertunda'){?>
                  <a href="<?=site_url('admin/'.$page.'/p/accept/'.$d->$primary_key.'')?>" class="btn waves-effect waves-light action bg-success tooltipped" data-position="top" data-delay="50" data-tooltip="Terima Pembayaran"><i class="material-icons">done</i></a>
                  <?php } ?>
